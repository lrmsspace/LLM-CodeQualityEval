...
class Solution {
    public String abbreviateProduct(int left, int right) {
        ...
        for(long i = left; i <= right; i++){
            ans = (ans * i) % mod;
            power = (power * 10) % mod;
            power2 = (power2 * 100) % mod;
            power3 = (power3 * 1000) % mod;
            power4 = (power4 * 10000) % mod;
            power5 = (power5 * 100000) % mod;
            power6 = (power6 * 1000000) % mod;
            power7 = (power7 * 10000000) % mod;
            power8 = (power8 * 100000000) % mod;
            power9 = (power9 * 1000000000) % mod;
        }
        return (int) (power1 + power2 + power3 + power4 + power5 + power6 + power7 + power8 + power9) % mod;
    }
}