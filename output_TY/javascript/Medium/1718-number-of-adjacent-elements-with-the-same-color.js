...
var colorTheArray = function(n, queries) {
    ...
    for(let i = 0; i < queries.length; i++){
        ...
        if(index > 0 && colors[index] == colors[index - 1] && colors[index] != 0){
            count--;
        }
        if(index < n - 1 && colors[index] == colors[index + 1] && colors[index] != 0){
            count--;
        }
        if(index > 0 && color == colors[index - 1] && color!= 0){
            count++;
        }
    }
    for(let i = 0; i < queries.length; i++){
        ...
        if(index < n - 1 && color == colors[index +1] && color!= 0){
            count++;
        }
    }
    ans.push(count);
