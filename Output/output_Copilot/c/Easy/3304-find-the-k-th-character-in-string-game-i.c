...
char kthCharacter(int k) {
    ...
    int operations = 0;
    int length = 1; // Initial length of the string "a"
    ...
    int position = k - 1; // Convert to 0-based index
    char result = 'a' + (position % 26); // Calculate the character based on the position
