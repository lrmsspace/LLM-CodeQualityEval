...
bool* checkIfPrerequisite(int numCourses, int** prerequisites, int prerequisitesSize, int* prerequisitesColSize, int** queries, int queriesSize, int* queriesColSize, int* returnSize) {
        ...
        *returnSize = queriesSize;
        ...
        // Create a 2D array to represent the reachability matrix
        bool reachability[numCourses][numCourses];
        memset(reachability, 0, sizeof(reachability));

        // Populate the reachability matrix based on prerequisites
