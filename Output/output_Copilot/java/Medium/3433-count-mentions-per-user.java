    ...
    public int[] countMentions(int numberOfUsers, List<List<String>> events) {
        ...
        for (List<String> event : events) {
            ...
            if (type.equals("OFFLINE")) {
                int userId = Integer.parseInt(event.get(2).substring(2));
                online[userId] = false;
                ...
                for (int userId : mentionedUsers) {
                    if (online[userId] || timestamp < offlineUntil.getOrDefault(userId, 0)) {
                        mentions[userId]++;
                    }
                }
            }
            ...
            for (int i = 0; i < numberOfUsers; i++) {
                if (!online[i] && timestamp >= offlineUntil.getOrDefault(i, 0)) {
                    online[i] = true;
                }
            }
        }
