...
var countPairsOfConnectableServers = function(edges, signalSpeed) {
    ...
    // Function to perform DFS and count pairs
    const dfs = (node, parent) => {
        ...
        for (const { node: neighbor, weight } of graph[node]) {
            ...
            const subCount = dfs(neighbor, node);
        ...
        count[node] = leftCount * rightCount;
        return leftCount + rightCount + 1; // Include current node
    };
