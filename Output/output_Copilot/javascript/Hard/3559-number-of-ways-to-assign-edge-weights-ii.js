...
var assignEdgeWeights = function(edges, queries) {
    ...
    const findPath = (u, v, visited, path) => {
        if (u === v) {
            path.push(u);
            return true;
        }
        ...
        for (const neighbor of graph[u]) {
            if (!visited[neighbor] && findPath(neighbor, v, visited, path)) {
                return true;
            }
        }
        path.pop();
