...
var buildMatrix = function(k, rowConditions, colConditions) {
    ...
    const rowIndegree = new Array(k + 1).fill(0);
    const colIndegree = new Array(k + 1).fill(0);
    ...
    const rowOrder = topologicalSort(rowGraph, rowIndegree, k);
    const colOrder = topologicalSort(colGraph, colIndegree, k);
    ...
    for (let i = 0; i < k; i++) {
        matrix[rowOrder[i] - 1][colOrder[i] - 1] = i + 1;
    }
