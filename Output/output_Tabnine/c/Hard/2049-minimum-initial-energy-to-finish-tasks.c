...
int minimumEffort(int** tasks, int tasksSize, int* tasksColSize) {
    // Sort the tasks by the difference between actual and minimum energy
    qsort(tasks, tasksSize, tasksColSize[0] * sizeof(int), compareTasks);
    ...
    for (int i = 0; i < tasksSize; i++) {
        ...
        // Add the actual energy required for the task to the current energy
        energy += actual;
    }
