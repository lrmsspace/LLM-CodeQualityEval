...
var minimizeSet = function(divisor1, divisor2, uniqueCnt1, uniqueCnt2) {
    let maxVal = Math.max(divisor1 * uniqueCnt1, divisor2 * uniqueCnt2);
    let minVal = Math.min(divisor1 * uniqueCnt1, divisor2 * uniqueCnt2);
    
    let diff = maxVal - minVal;
    let res = minVal + Math.floor(diff / 2);
