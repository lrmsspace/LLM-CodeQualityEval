...
class Solution(object):
    def passThePillow(self, n, time):
        ...
        # Initialize the person holding the pillow
        person = 1
        
        # Iterate until the time is up
        for _ in range(time):
            # Update the person holding the pillow
            person = (person + direction) % n
        
        # Return the index of the person holding the pillow
        return person
