...
class Solution(object):
    def specialGrid(self, n):
        ...
        def fill_quadrant(start, end):
            quadrant = [[0 for _ in range(end - start)] for _ in range(end - start)]
            num = start
        ...
        def merge_quadrants(q1, q2, q3, q4):
        ...
        q1 = fill_quadrant(0, n)
        q2 = fill_quadrant(n, 2 * n)
        q3 = fill_quadrant(2 * n * n - n, 2 * n * n)
        q4 = fill_quadrant(2 * n * n - 2 * n, 2 * n * n - n)
        
        return merge_quadrants(q1, q2, q3, q4)        