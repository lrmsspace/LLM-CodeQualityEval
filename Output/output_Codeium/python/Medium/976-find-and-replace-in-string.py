...
class Solution(object):
    def findReplaceString(self, s, indices, sources, targets):
        ...
        :rtype: str
        """
        # Create a list of tuples (index, source, target) and sort by index in descending order
        ...
        for index, source, target in replacements:
            # Check if the source matches the substring in the original string at the specified index
