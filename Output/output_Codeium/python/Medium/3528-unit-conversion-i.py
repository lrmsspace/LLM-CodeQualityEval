...
class Solution(object):
    def baseUnitConversions(self, conversions):
        ...
        """
        n = len(conversions) + 1
        baseUnitConversion = [1] + [0] * (n - 1)
        for conversion in conversions:
            sourceUnit, targetUnit, conversionFactor = conversion
            baseUnitConversion[targetUnit] = (baseUnitConversion[sourceUnit] * conversionFactor) % (10**9 + 7)
