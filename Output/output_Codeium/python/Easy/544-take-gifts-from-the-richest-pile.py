...
class Solution(object):
    def pickGifts(self, gifts, k):
        ...
        # Convert gifts list into a max heap (invert values for max heap simulation using min heap)
        max_heap = [-gift for gift in gifts]
        heapq.heapify(max_heap)

        for _ in range(k):
            # Take the largest pile (invert the value back)
            ...
            # Push the remaining gifts back into the heap (invert value)
