...
var maxProfit = function(n, present, future, hierarchy, budget) {
    ...
    // Calculate profit and initial cost for each employee
    for (let i = 0; i < n; i++) {
    ...
    for (const [boss, employee] of hierarchy) {
        cost[employee - 1] = Math.floor(present[employee - 1] / 2);
    }
    ...
    for (let i = 0; i < (1 << n); i++) {
        ...
        // Update maxProfit if the total cost is within the budget
