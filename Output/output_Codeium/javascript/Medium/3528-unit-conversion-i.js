...
var baseUnitConversions = function(conversions) {
    let n = conversions.length + 1;
    let baseUnitConversion = new Array(n).fill(1);
    for (let conversion of conversions) {
        let sourceUnit = conversion[0];
        let targetUnit = conversion[1];
        let conversionFactor = conversion[2];
        baseUnitConversion[targetUnit] = (baseUnitConversion[sourceUnit] * conversionFactor) % 1000000007;
    }
