 ...
 */ 
// Helper function to compare two arrays based on their first element
...
int** mergeSimilarItems(int** items1, int items1Size, int* items1ColSize, int** items2, int items2Size, int* items2ColSize, int* returnSize, int** returnColumnSizes) {
    ...
    // Sum up weights from items1
    for (i = 0; i < items1Size; i++) {
        weights[items1[i][0]] += items1[i][1];
    }

    // Sum up weights from items2
    ...
    *returnColumnSizes = (int*)malloc(count * sizeof(int));
    ...
    // Sort the result array based on the values
