...
class Solution {
    public int[][] spiralMatrix(int m, int n, ListNode head) {
        ...
        while (current!= null) {
            ...
            if (direction == 0 && (col == n - 1 || matrix[row][col + 1]!= -1)) {
                direction = 1;
                row++;
            } else if (direction == 1 && (row == m - 1 || matrix[row + 1][col]!= -1)) {
                direction = 2;
                col--;
            } else if (direction == 2 && (col == 0 || matrix[row][col - 1]!= -1)) {
                direction = 3;
                row--;
            } else if (direction == 3 && (row == 0 || matrix[row - 1][col]!= -1)) {
                direction = 0;
                col++;
            }
