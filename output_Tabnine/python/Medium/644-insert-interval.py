...
class Solution(object):
    def insert(self, intervals, newInterval):
        ...
        for interval in intervals[1:]:
            # If the current interval doesn't overlap with the new interval, add it to the result
        ...
        # Add the new interval if it doesn't overlap with any of the existing intervals
