...
class Solution(object):
    def isRobotBounded(self, instructions):
        ...
        # Check if the robot has returned to its initial position
        return (x, y) == (0, 0) or any(direction in ['N', 'S'] for direction, (dx, dy) in directions.items() if x + dx == 0 or y + dy == 0)
