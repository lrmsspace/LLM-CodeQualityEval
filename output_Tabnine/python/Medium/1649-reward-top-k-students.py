...
class Solution(object):
    def topStudents(self, positive_feedback, negative_feedback, report, student_id, k):
        ...
        sorted_students = sorted(feedback_dict.items(), key=lambda x: (-x[1], x[0]))
        return [student_id for student_id, points in sorted_students[:k]]
