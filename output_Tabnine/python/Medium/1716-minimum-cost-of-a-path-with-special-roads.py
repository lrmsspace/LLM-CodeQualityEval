...
class Solution(object):
    def minimumCost(self, start, target, specialRoads):
        ...
        for road in specialRoads:
            graph[road[0] - 1].append((road[1] - 1, road[4]))
            graph[road[1] - 1].append((road[0] - 1, road[4]))
        
        dist = [float('inf')] * N
        dist[start[0] - 1] = dist[start[1] - 1] = 0
        
        pq = [(0, start[0] - 1), (0, start[1] - 1)]
        while pq:
        ...
        return dist[target[0] - 1] + dist[target[1] - 1]
