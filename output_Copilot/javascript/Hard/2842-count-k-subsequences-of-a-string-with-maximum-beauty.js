...
var countKSubsequencesWithMaxBeauty = function(s, k) {
    ...
    // Filter out characters with zero frequency and sort in descending order
    const counts = freq.filter(x => x > 0).sort((a, b) => b - a);
    ...
    // Calculate the number of ways to choose k characters with maximum beauty
    let ways = 1;
    for (let i = 0; i < k; i++) {
