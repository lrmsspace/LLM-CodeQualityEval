...
var baseUnitConversions = function(conversions) {
    ...
    const baseUnitConversion = new Array(n).fill(0);
    baseUnitConversion[0] = 1;

    for (const [sourceUnit, targetUnit, conversionFactor] of conversions) {
        baseUnitConversion[targetUnit] = (baseUnitConversion[targetUnit] + baseUnitConversion[sourceUnit] * conversionFactor) % (10 ** 9 + 7);
    }
