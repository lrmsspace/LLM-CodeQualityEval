...
var assignEdgeWeights = function(edges) {
    ...
    // DFS to find the maximum depth and count nodes at that depth
    ...
    dfs(0, -1, 0); // Start DFS from node 0 (1 in problem statement)
    
    // The number of ways to assign weights such that the total cost is odd
    return countAtMaxDepth * Math.pow(2, maxDepth - 1) % MOD;
