...
class Solution {
    public int primeSubarray(int[] nums, int k) {
        ...
        // Sieve of Eratosthenes to find all prime numbers up to 50000
        ...
        for (int start = 0; start < n; start++) {
            ...
            for (int end = start; end < n; end++) {
                ...
                // Check if we have at least two primes and the gap condition
                if (foundPrime && maxPrime - minPrime <= k) {
                    count++;
                }
            }
        }
