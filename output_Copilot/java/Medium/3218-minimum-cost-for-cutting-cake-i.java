...
class Solution {
    public int minimumCost(int m, int n, int[] horizontalCut, int[] verticalCut) {
        ...
        while (hPointer >= 0 || vPointer >= 0) {
            if (hPointer < 0) {
                // Only vertical cuts left
                totalCost += verticalCut[vPointer--] * hPieces;
            } else if (vPointer < 0) {
                // Only horizontal cuts left
                totalCost += horizontalCut[hPointer--] * vPieces;
            } else if (horizontalCut[hPointer] > verticalCut[vPointer]) {
