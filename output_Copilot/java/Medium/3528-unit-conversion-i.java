...
class Solution {
    public int[] baseUnitConversions(int[][] conversions) {
        ...
        for (int[] conversion : conversions) {
            ...
            long conversionFactor = conversion[2];
            baseUnitConversion[targetUnit] = (baseUnitConversion[targetUnit] + baseUnitConversion[sourceUnit] * conversionFactor) % 1000000007;
        }

        return Arrays.stream(baseUnitConversion).mapToInt(Long::intValue).toArray();
    }
}